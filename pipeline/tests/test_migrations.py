...
class MigrationTest(unittest.TestCase):
    ...
    def test_migrate_to_current_runs_the_complete_chain(self) -> None:
        ...
        self.assertEqual(publication["manifest"]["contractVersion"], "0.8.0")
        self.assertEqual(publication["passageAlignments"], [])
        self.assertEqual(publication["sourceRelations"], [])
        self.assertEqual(
    ...
    def test_0_7_to_0_8_adds_only_the_source_relation_collection(self) -> None:
        publication_0_4, _ = migrate_0_3_to_0_4(_old_publication())
        publication_0_5, _ = migrate_0_4_to_0_5(publication_0_4)
        publication_0_6, _ = migrate_0_5_to_0_6(publication_0_5)
        publication_0_7, _ = migrate_0_6_to_0_7(publication_0_6)
        publication, report = migrate_0_7_to_0_8(publication_0_7)
        self.assertEqual(publication["manifest"]["contractVersion"], "0.8.0")
        self.assertEqual(publication["sourceRelations"], [])
        self.assertEqual(publication["assertions"], publication_0_7["assertions"])
        self.assertEqual(report["createdSourceRelations"], 0)
